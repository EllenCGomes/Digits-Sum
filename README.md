...
EXERCISE DESCRIPTION: Write a program that receives an integer and prints the sum of the digits.
...
DESCRIÇÃO: Escreva um programa que receba um número inteiro e imprima a soma dos dígitos deste número.
